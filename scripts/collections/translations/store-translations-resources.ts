...
import type { GetTranslatableCollectionsQuery } from "../../../app/types/admin.generated.js";
...
const ALLOWED_KEYS = new Set(["title", "body_html", "handle"]);


console.log("Fetching all COLLECTION translatable resources...");
...
try {
  do {
    page++;
    const result: GraphQLResponse<GetTranslatableCollectionsQuery> =
  ...
  const outputPath = new URL(
    "./collection-translation-resources.json",
    import.meta.url
  );
